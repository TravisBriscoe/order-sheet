...
class ManageProducts extends React.Component {
	...
	onAddNewProduct(bool) {
		...
		if (bool) {
			this.setState(
				(prevState) => ({ addNewProduct: !prevState.addNewProduct }),
				() => {
					if (pathname !== "/manage/edit-products")
		...
		return (
			<div className="manage-products">
				{this.props.sortedProds ? (
					<div className="manage-products-actions">
						<div className="manage-products-actions-btn--new_product">
							<button
								disabled={this.state.addNewProduct ? "disabled" : ""}
								onClick={() => this.onAddNewProduct(true)}
							>
								Create New Product
							</button>
						</div>
						<div className="manage-products-actions-menu">
							<select
								className="manage-products-actions-menu--category"
							...
							<input
								type="text"
								className="manage-products-actions-menu--search_bar"
								placeholder="Search by Name or Description"
								onInput={(event) => this.onChangeSelect(event)}
							/>
						</div>
					</div>
				) : (
				...
				<div className="manage-products-list">
					<ProductNav
						products={this.props.sortedProds}
				...
				<div className="manage-products-edit">
					{!this.state.addNewProduct ? (
						<Switch>
							<Route path={`${process.env.PUBLIC_URL}/manage/edit-products/:productId`}>
								<EditProduct
